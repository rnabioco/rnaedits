...
rpt_bed <- rpt_bed %>% 
  ...
  summarize(repeat_names = valr::values_unique(name.y), 
            ...
            repeat_present = dplyr::first(repeat_found))
```
...
file.copy("hyperedits/sig_repeat_distribution.pdf",
          figs_dir[4], overwrite = T)
rpt_bed_annotated  %>% 
...
file.copy("hyperedits/repeat_classification.pdf", figs_dir[4], overwrite = T)
```
...
file.copy("hyperedits/nonsig_repeat_distribution.pdf",
          figs_dir[4], overwrite = T)
```
