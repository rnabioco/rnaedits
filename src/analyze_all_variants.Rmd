...
# for some unknown reason this previous definition is not recognized when running on tesla. this only
# took two hours of my life. 
...
names(cpms) <- c("Medulla",
                     "Hypothalamus",
                     "Forebrain")
outprefix <- paste0(prefix, "/", outname, "/", ref, "_", alt, "_")
